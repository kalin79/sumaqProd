...
import Finalizado from '@/components/Cart/Finalizado'
export default {
     components: {
          BannerCartFinal,
          Finalizado
     ...
     head () {
          return {
               title: 'Sumaq - Finalizacion de compra',
               meta: [
               ...
               { hid: 'og:image', property: 'og:image', name: 'og:image', content: '' }, 
               { hid: 'og:description', property: 'og:description', name: 'og:description', content: '' }, 
               { hid: 'og:site_name', property: 'og:site_name', name: 'og:site_name', content: '' }, 
