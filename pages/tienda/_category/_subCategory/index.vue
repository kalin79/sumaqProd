...
export default {
     ...
     mounted() {
          this.titleHead = `${this.getDataCategoryNivel1.title} :: Tienda de ${this.getDataCategoryNivel1.sub_categorias[0].title}`
          this.descriptionHead = this.getDataCategoryNivel1.sub_categorias[0].description
     },
     head () {
          return {
