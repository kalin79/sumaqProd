...
export default {
     ...
     head () {
          return {
               ...
               // Open Graph data
               { hid: 'og:title', property: 'og:title',  content: 'SUMAQ.pe - Bienvenido en donde podras encontrar el regalo perfecto' }, 
               { hid: 'og:type', property: 'og:type', content: 'article' }, 
               { hid: 'og:url', property: 'og:url', content: 'https://floreriasumaq.pe/' }, 
               { hid: 'og:image', property: 'og:image', content: 'https://floreriasumaq.pe/facebook.jpeg' }, 
               { hid: 'og:description', property: 'og:description', content: 'Bienvenido en donde podras encontrar el regalo perfecto' }, 
