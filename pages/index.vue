<template>
     <div class="pageConstruccion">
          <div class="centerElement d-flex flex-column justify-content-center align-items-center">
               <div class="logoBox">
                    <img src="@/assets/images/logoP3.png" />
               </div>
               <div class="florBox">
                    <img src="@/assets/images/florConst.png" />
               </div>
...
export default {
     ...
     head () {
          return {
               ...
               // Open Graph data
               { hid: 'og:title', property: 'og:title', name: 'og:title', content: 'SUMAQ.pe - Bienvenido en donde podras encontrar el regalo perfecto' }, 
               ...
               { hid: 'og:image', property: 'og:image', name: 'og:url', content: 'https://floreriasumaq.pe/facebook.jpeg' }, 
               { hid: 'og:description', property: 'og:description',  name: 'og:description', content: 'Bienvenido en donde podras encontrar el regalo perfecto' }, 
...
<style lang="sass">
     .pageConstruccion
          width: 100vw
          height: 100vh
          background-image: url('@/assets/images/fondoConstruccion.jpg')
