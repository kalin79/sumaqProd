                                                                 ...
                                                                 <div class="tabs">
                                                                      ...
                                                                      <div class="tab-content d-flex justify-content-center">
                                                                           <section id="tab-item-1" class="active">
                                                                                <!-- <client-side> -->
                                                                                <b-calendar v-model="CalendarValue" @selected="setDaySelect()" :min="minDate.toISOString()" @context="onContext" locale="es-Es"></b-calendar>
                                                                                <!-- </client-side> -->
                                                                           </section>
                                                                           ...
                                                                           <div class="row mb-3 mt-3">
                                                                                <div class="col">
                                                                                     <div class="boxSwitch d-flex flex-row align-items-center justify-content-start">
                                                                                          <!-- <p>Sin Mensaje</p> -->
                                                                                          <div class="switch">
                                                                                               <input id="switch" class="switch__input" name="switch" checked type="checkbox" @click="changeMensaje">
