                         ...
                         <div class="row">
                              <div class="col">
                                   <div class="boxDetail separateDetail">
                                        <h2>Compra segura, aceptamos todas las tarjetas.</h2>
                                   </div>
                                   <div class="boxTarjetas">
                                        <div class="row">
                                             <div class="col-3">
...
<style lang="sass">
     .footerMain
          ...
          .boxDetail
               h2
                    @include font-libre(.938rem,.8rem,.8rem,.85rem,$Montserrat,600,white)
                    line-height: 1.5em
               ul
                    margin: 0
                    padding: 0
                         ...
                         .boxSocial
                              ...
                              .icon-facebook
                                   ...
                                   @media screen and (min-width: 992px)
                                        font-size: 1.5rem
                         a
                              @include font-libre(.75rem,.7rem,.7rem,.8rem,$Montserrat,300,white)
                              text-decoration: none
